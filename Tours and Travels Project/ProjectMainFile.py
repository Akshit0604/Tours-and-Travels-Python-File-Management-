 ...
 *Overview:
 ...
 It ahs been a hideouy from scorching summer from the British days,infact it was the summer
 ...
 *Highlights
 ...
 tk.mainloop()
 OOTY=open("Ootypro.txt","r") #using file handling to import and display daywise itinerary for
ooty
OP=OOTY.read()
print(OP)
...
while True:
 ...
 if d==lottery: #calculating bill
  ...
  print("NOTE 1:Price per head is the price only for 1 day including tax")
  print("NOTE 2:Price for passengers of age below 12 will be charged only half of the originalprice")
...
if d==lottery:
 ...
 quote = """GOA:
 *Overview
 Vacation is refreshment, a way to rejuvenate your senses. Goa is a must visit destination for this
purpose.
 This Indian state is a platform of utmost fun and an exciting vacation. Goa beaches are known
for awesome scenic beauty and safe night life.
 The luxurious villas at the beaches offer soothing Ayurveda massages, which have always been
known for their extensive health benefits.
 The Portuguese influence can still be found in the life style of the locals.
 Some of the oldest churches of the country can be seen here, which are known for their
invaluable inscriptions and unique architecture.
 A land of spices and sea food, you can satisfy your taste buds with spicy prawn fries, quality
wine and more.
 ...
 *Highlights
 ...
 while True:
     if cp==1:
 print("NOTE 1:Price per head is the price only for 1 day including tax")
 print("NOTE 2:Price for passengers of age below 12 will be charged only half of the original
price")
 print("\nPrice per head for age 12 and above:Rs. 2100")
 print("Price per head for age below 12:Rs. 1050")
 maj1=int(input("\nNumber of people aged 12 and above:"))
 ...
 bill=4*((maj1*2100)+(min1*1050))
 print("\nWe offer a lucky lottery type of discount for our customers")
 print("The program would generate a random number from 10 to 20 and if you guess it
right, there would be a discount of 10% on the final amount")
 lottery=int(input("Choose a number from 10 to 20"))
 d=random.randint(10,20)
 print("The number generated by the program is:",d)
 print("Price for one day(inc tax):",bill/4)
 ...
 *Overview:
 ...
 The Edakkal caves are the glowing evidence of the claim. However, there is not much of
documented history of this region before the 18th century.
 Wayanad has the largest tribal community in Kerala. Many of these tribal groups were treated
as slaves by the landlords for a long time.
 The historic Bonded Labor Act of 1976 made this unconstitutional. Now, most of these tribes
make a living from their skills in agriculture,
 carpentry, and craftsmanship. You can learn a lot about the tribes of Wayanad and their life in
the Wayanad Heritage Museum.
 Wayanad is surrounded by the Bandipur, Nagarhole and Mudumalai forests in the east. These
three together with the eastern forests of Wayanad has
 ...
 The region Sultan Bathery in the interiors of Wayanad is famous for the Edakkal Caves and other
heritage sites.
 *Highlights:
 -Banasura Sagara Dam
 -Chembra Peak
 ...
 T.insert(tk.END, quote)
 tk.mainloop()
 WAY=open("Waypro.txt","r")#using file handling to import and display daywise itinerary for
wayanad
 WP=WAY.read()
 print(WP)
...
right, there would be a discount of 10% on the final amount")
 ...
 quote = """HYDERABAD:
 *Overview:
 Hyderabad is the capital of southern India's Telangana state. A major center for the technology
industry,
 ...
 The Charminar, a 16th-century mosque whose 4 arches support towering minarets, is an old city
 ...
 *Highlights:
 ...
 T.insert(tk.END, quote)
 tk.mainloop()
 HYD=open("Hydpro.txt","r")#using file handling to import and display daywise itinerary for
hyderabad
 HP=HYD.read()
 print(HP)
...
Peshwas (prime ministers) of the Maratha Empire,
 which lasted from 1674 to 1818. It's known for the grand Aga Khan Palace, built in 1892 and
now a memorial to Mahatma Gandhi,
 whose ashes are preserved in the garden. The 8th-century Pataleshwar Cave Temple is
 ...
 *Highlights:
 ...
 PUNE=open("Punepro.txt","r")#using file handling to import and display daywise itinerary for
pune
 PP=PUNE.read()
 print(PP)
...
print("\nFor more details or queries, contact Mr Hemanth at 9999999999/9090909090 who would
be the guide for the tour")
print("\nWould you like to confirm the booking of the tour and go ahead with the online payment
integrated within our site")
pay=input("Y for yes, N for no")
def abc(): #bill payment

 if pay=='Y' or pay=='y':

 print("\nYou would be transferring the amount and the site will have access to your bank
account if you have registered with your phone number in the site")
