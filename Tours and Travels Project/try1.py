...
while True:          #using conditional statements(while loop)
    ...
    if ch==1:
        ...
        *Highlights
        ...
        import mysql.connector as db #using mysql connector to display tables of ooty
        mydb=db.connect(host="localhost",user="root",passwd="12345",database="packages")
        cursor=mydb.cursor()
        cursor.execute("select * from ooty")
        rec=cursor.fetchall()
        for r in rec:
            print(r)
        ...
        *Highlights
        ...
        import mysql.connector as db #using mysql connector to display tables of goa
        mydb=db.connect(host="localhost",user="root",passwd="12345",database="packages")
        cursor=mydb.cursor()
        cursor.execute("select * from goa")
        rec=cursor.fetchall()
        for r in rec:
            print(r)
        ...
        *Highlights:
        ...
        import mysql.connector as db #using mysql connector to display tables of wayanad
        mydb=db.connect(host="localhost",user="root",passwd="12345",database="packages")
        cursor=mydb.cursor()
        cursor.execute("select * from wayanad")
        rec=cursor.fetchall()
        for r in rec:
            print(r)
        ...
        *Highlights:
        ...
        import mysql.connector as db #using mysql connector to display tables of hyderabad
        mydb=db.connect(host="localhost",user="root",passwd="12345",database="packages")
        cursor=mydb.cursor()
        ...
        *Highlights:
        ...
        import mysql.connector as db #using mysql connector to display tables of pune
        mydb=db.connect(host="localhost",user="root",passwd="12345",database="packages")
        cursor=mydb.cursor()
